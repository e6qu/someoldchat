...
func scopedRoutes() []scopedRoute {
	return []scopedRoute{
		...
		{http.MethodGet, "/api/assistant.search.context", auth.ScopeSearchRead},
		{http.MethodPost, "/api/assistant.search.context", auth.ScopeSearchRead},
		{http.MethodGet, "/api/admin.audit.anomaly.allow.getItem", auth.ScopeAuditLogsRead},
		{http.MethodPost, "/api/admin.audit.anomaly.allow.getItem", auth.ScopeAuditLogsRead},
		{http.MethodPost, "/api/admin.audit.anomaly.allow.updateItem", auth.ScopeAuditLogsRead},
		{http.MethodGet, "/api/team.billing.info", auth.ScopeTeamRead},
		...
		{http.MethodPost, "/api/admin.analytics.messages.activity", auth.ScopeAdminAnalyticsRead},
		{http.MethodGet, "/api/admin.analytics.messages.metadata", auth.ScopeAdminAnalyticsRead},
		{http.MethodPost, "/api/admin.analytics.messages.metadata", auth.ScopeAdminAnalyticsRead},
		{http.MethodGet, "/api/apps.activities.list", auth.ScopeAuthorizationsRead},
		{http.MethodPost, "/api/apps.activities.list", auth.ScopeAuthorizationsRead},
		{http.MethodGet, "/api/admin.apps.activities.list", auth.ScopeAdminAppsRead},
		{http.MethodPost, "/api/admin.apps.activities.list", auth.ScopeAdminAppsRead},
		{http.MethodGet, "/api/admin.conversations.lookup", auth.ScopeAdminConversationsRead},
		{http.MethodPost, "/api/admin.conversations.lookup", auth.ScopeAdminConversationsRead},
		{http.MethodPost, "/api/admin.conversations.bulkMove", auth.ScopeAdminConversationsWrite},
		{http.MethodPost, "/api/admin.conversations.bulkSetExcludeFromSlackAi", auth.ScopeAdminConversationsWrite},
		{http.MethodPost, "/api/admin.conversations.linkObjects", auth.ScopeAdminConversationsWrite},
		{http.MethodPost, "/api/admin.conversations.unlinkObjects", auth.ScopeAdminConversationsWrite},
		{http.MethodPost, "/api/admin.conversations.createForObjects", auth.ScopeAdminConversationsWrite},
		{http.MethodGet, "/api/admin.apps.config.lookup", auth.ScopeAdminAppsRead},
		{http.MethodPost, "/api/admin.apps.config.lookup", auth.ScopeAdminAppsRead},
		{http.MethodPost, "/api/admin.apps.config.set", auth.ScopeAdminAppsWrite},
		{http.MethodPost, "/api/admin.apps.clearResolution", auth.ScopeAdminAppsWrite},
		{http.MethodGet, "/api/admin.functions.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodPost, "/api/admin.functions.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodPost, "/api/admin.functions.permissions.set", auth.ScopeAdminWorkflowsWrite},
		{http.MethodGet, "/api/admin.workflows.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodPost, "/api/admin.workflows.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodGet, "/api/admin.workflows.triggers.types.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodPost, "/api/admin.workflows.triggers.types.permissions.lookup", auth.ScopeAdminWorkflowsRead},
		{http.MethodPost, "/api/admin.workflows.triggers.types.permissions.set", auth.ScopeAdminWorkflowsWrite},
		{http.MethodPost, "/api/admin.barriers.create", auth.ScopeAdminBarriersWrite},
		{http.MethodPost, "/api/admin.barriers.update", auth.ScopeAdminBarriersWrite},
		{http.MethodPost, "/api/admin.barriers.delete", auth.ScopeAdminBarriersWrite},
		{http.MethodGet, "/api/admin.barriers.list", auth.ScopeAdminBarriersRead},
		{http.MethodPost, "/api/admin.barriers.list", auth.ScopeAdminBarriersRead},
		{http.MethodPost, "/api/admin.users.session.setSettings", auth.ScopeAdminUsersWrite},
		{http.MethodPost, "/api/admin.users.session.clearSettings", auth.ScopeAdminUsersWrite},
		{http.MethodGet, "/api/admin.users.session.getSettings", auth.ScopeAdminUsersRead},
		{http.MethodPost, "/api/admin.users.session.getSettings", auth.ScopeAdminUsersRead},
		{http.MethodPost, "/api/admin.auth.policy.assignEntities", auth.ScopeAdminUsersWrite},
		{http.MethodPost, "/api/admin.auth.policy.removeEntities", auth.ScopeAdminUsersWrite},
		{http.MethodGet, "/api/admin.auth.policy.getEntities", auth.ScopeAdminUsersRead},
		{http.MethodPost, "/api/admin.auth.policy.getEntities", auth.ScopeAdminUsersRead},
		{http.MethodPost, "/api/admin.roles.addAssignments", auth.ScopeAdminRolesWrite},
		{http.MethodPost, "/api/admin.roles.removeAssignments", auth.ScopeAdminRolesWrite},
		{http.MethodGet, "/api/admin.roles.listAssignments", auth.ScopeAdminRolesRead},
		{http.MethodPost, "/api/admin.roles.listAssignments", auth.ScopeAdminRolesRead},
		...
		{http.MethodPost, "/api/admin.conversations.bulkArchive", auth.ScopeAdminConversationsWrite},
		{http.MethodPost, "/api/admin.conversations.bulkDelete", auth.ScopeAdminConversationsWrite},
