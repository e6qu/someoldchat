...
func (c *callsServiceClient) InviteToHuddle(ctx context.Context, in *HuddleInviteRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MutationResponse)
	err := c.cc.Invoke(ctx, CallsService_InviteToHuddle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCallsServiceServer) CallInfo(context.Context, *CallRequest) (*Call, error) {
	return nil, status.Error(codes.Unimplemented, "method CallInfo not implemented")
}
func (UnimplementedCallsServiceServer) UpdateCall(context.Context, *UpdateCallRequest) (*Call, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateCall not implemented")
}
func (UnimplementedCallsServiceServer) AddCallParticipants(context.Context, *CallParticipantsRequest) (*MutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddCallParticipants not implemented")
}
func (UnimplementedCallsServiceServer) RemoveCallParticipants(context.Context, *CallParticipantsRequest) (*MutationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveCallParticipants not implemented")
}
...
func _CallsService_InviteToHuddle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HuddleInviteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CallsServiceServer).InviteToHuddle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CallsService_InviteToHuddle_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CallsServiceServer).InviteToHuddle(ctx, req.(*HuddleInviteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CallsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CallsService_InviteToHuddle_Handler,
		},
		{
			MethodName: "AddCall",
