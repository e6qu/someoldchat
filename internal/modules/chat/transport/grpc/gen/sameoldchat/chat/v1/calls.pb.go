...
func (x *HuddleInviteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *HuddleInviteRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *HuddleInviteRequest) GetInviteeId() string {
	if x != nil {
		return x.InviteeId
	}
	return ""
...
func (x *HuddleInviteRequest) GetConversationId() string {
	if x != nil {
		return x.ConversationId
	}
	return ""
...
const file_sameoldchat_chat_v1_calls_proto_rawDesc = "" +
	...
	"\n" +
	"invitee_id\x18\x03 \x01(\tR\tinviteeId\x12'\n" +
	"\x0fconversation_id\x18\x04 \x01(\tR\x0econversationId\"\xb9\x01\n" +
