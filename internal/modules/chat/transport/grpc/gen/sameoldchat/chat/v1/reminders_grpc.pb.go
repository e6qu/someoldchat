...
func (UnimplementedRemindersServiceServer) ReminderInfo(context.Context, *ReminderRequest) (*Reminder, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReminderInfo not implemented")
}
func (UnimplementedRemindersServiceServer) Reminders(context.Context, *RemindersRequest) (*ReminderPage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Reminders not implemented")
}
...
func RegisterRemindersServiceServer(s grpc.ServiceRegistrar, srv RemindersServiceServer) {
	// If the following call pancis, it indicates UnimplementedRemindersServiceServer was
