...
func (x *TypingSignal) GetConversation() string {
	if x != nil {
		return x.Conversation
	}
	return ""
...
func (x *TypingSignal) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *TypingSignal) GetExpiresAtUnixNano() int64 {
	if x != nil {
...
func (x *SetTypingRequest) GetConversation() string {
	if x != nil {
		return x.Conversation
	}
	return ""
...
type TypingSignalsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	WorkspaceId   string                 `protobuf:"bytes,1,opt,name=workspace_id,json=workspaceId,proto3" json:"workspace_id,omitempty"`
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *TypingSignalsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TypingSignalsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type TypingSignalsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Signals       []*TypingSignal        `protobuf:"bytes,1,rep,name=signals,proto3" json:"signals,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TypingSignalsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_sameoldchat_chat_v1_interactions_proto_rawDesc = "" +
	...
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\"\n" +
	"\fconversation\x18\x03 \x01(\tR\fconversation\x12\x1b\n" +
	"\tthread_ts\x18\x04 \x01(\tR\bthreadTs\"\x9f\x01\n" +
	"\fTypingSignal\x12!\n" +
	"\fworkspace_id\x18\x01 \x01(\tR\vworkspaceId\x12\"\n" +
	"\fconversation\x18\x02 \x01(\tR\fconversation\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userId\x12/\n" +
	"\x14expires_at_unix_nano\x18\x04 \x01(\x03R\x11expiresAtUnixNano\"r\n" +
	"\x10SetTypingRequest\x12!\n" +
	"\fworkspace_id\x18\x01 \x01(\tR\vworkspaceId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\"\n" +
	"\fconversation\x18\x03 \x01(\tR\fconversation\"#\n" +
	"\x11SetTypingResponse\x12\x0e\n" +
	"\x02ok\x18\x01 \x01(\bR\x02ok\"R\n" +
	"\x14TypingSignalsRequest\x12!\n" +
	"\fworkspace_id\x18\x01 \x01(\tR\vworkspaceId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\"T\n" +
	"\x15TypingSignalsResponse\x12;\n" +
	"\asignals\x18\x01 \x03(\v2!.sameoldchat.chat.v1.TypingSignalR\asignals\"S\n" +
	...
	"\x12GetAssistantThread\x12+.sameoldchat.chat.v1.AssistantThreadRequest\x1a$.sameoldchat.chat.v1.AssistantThread\x12Z\n" +
