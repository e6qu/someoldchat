...
- The guard-mutation gate in `tests/mutation` strips every authorization guard
  ...
  exhaustive audit took that ceiling from 103 to 61 and the surviving-guard
  ...
  list-column-removal, group-DM-to-private and workspace-profile-field-delete operations. What remains is named residue: operations owner-only on a
