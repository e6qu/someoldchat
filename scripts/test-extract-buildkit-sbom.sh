...
printf '%s\n' '{"_type":"https://in-toto.io/Statement/v1","predicateType":"https://slsa.dev/provenance/v1","subject":[],"predicate":{"buildDefinition":{"buildType":"https://github.com/moby/buildkit"},"runDetails":{"builder":{"id":"fixture"}}}}' >"$fixture/blobs/sha256/$provenance"
...
jq -e '.buildDefinition.buildType == "https://github.com/moby/buildkit"' "$output" >/dev/null
